(function() {
  ...
  ChoicesCollection = (function(_super) {
    ...
    ChoicesCollection.prototype.showPositiveConnector = function(show) {
      this.setShowLineConnector(this.last(), show);
      return this;
    };

    ChoicesCollection.prototype.setShowLineConnector = function(model, show) {
      if (model != null) {
        model.set('showLineConnector', show);
      }
      return this;
    };
